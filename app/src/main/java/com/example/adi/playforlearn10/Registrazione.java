...
import static com.example.adi.playforlearn10.R.id.radioButton;
import static com.example.adi.playforlearn10.R.id.radioButton1;
import static com.example.adi.playforlearn10.R.id.radioButton2;
import static com.example.adi.playforlearn10.R.id.radioButton3;
import static com.example.adi.playforlearn10.R.id.radioButton4;
import static com.example.adi.playforlearn10.R.id.radioButton5;
...
public class Registrazione extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
       ...
       // toolbar.setTitle("Registrazione "+ tipologia);
        ...
        Button registra = (Button) findViewById(R.id.btOK);
            ...
            public void onClick(View v) {
                switch(tipologia){
                    case "alunno":
                        ...
                        break;
                    case "insegnante":
                        if(!send(creaStringaJSInsegnante()))Toast.makeText(getApplicationContext(),"Operazione non riuscita",Toast.LENGTH_LONG).show();
    ...
    public void utenteOInsegnante(String tipologia){
        if(tipologia.compareToIgnoreCase("alunno")==0) {
            ...
            linear_insegnante.setEnabled(false);
                ...
                linear_alunno.setEnabled(false);
    ...
    public String creaStringaJSInsegnante(){
        ...
        CheckBox chItaliano= (CheckBox) findViewById(R.id.italiano);
        CheckBox chmatematica= (CheckBox) findViewById(R.id.matematica);
        CheckBox chinglese= (CheckBox) findViewById(R.id.inglese);
        CheckBox chstoria= (CheckBox) findViewById(R.id.storia);
        CheckBox chgeografia= (CheckBox) findViewById(R.id.geografia);
        ...
        new AsyncTask<Object,Boolean,Object>(){
            ...
            protected Object doInBackground(Object... params) {
                try {
                    ...
                    String ip = "192.168.1.20", nomeFile="webservice/addUtente.php";
                    int porta = 80;
                    ...
                    bufferedWriter.write(tipologia+" "+toSend);
    ...
    /**
     * permette di annullare l'operazione in corso tornando alla pagina precente
     */
    public void back() {
       Intent i =new Intent(getApplicationContext(), LoginActivityDaniele.class);
        startActivity(i);
        finish();
    }
}
