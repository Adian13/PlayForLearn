...
public class RegistrazioneMaestra extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String REGISTER_URL ="http://172.19.51.169:80/webservice/addUtente.php";
    private Button registrati, annulla;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registrati=(Button)findViewById(R.id.registrazioneMaestra);
